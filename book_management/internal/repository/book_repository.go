...
type BookRepository interface {
	...
	GetOneBook(ctx context.Context, id uint64) (*entity.Book, error)
}
...
func (r *bookRepositoryImpl) GetOneBook(ctx context.Context, id uint64) (*entity.Book, error) {
	q := `
    SELECT 
        b.book_id,
        b.book_title,
    ...
    LEFT JOIN book_items bi ON b.book_id = bi.book_id
    LEFT JOIN book_authors ba ON b.book_id = ba.book_id
	WHERE b.deleted_at is null and bc.deleted_at is null and ba.deleted_at is null and b.book_id=$1
    GROUP BY 
        b.book_id, 
        b.book_title, 
        b.isbn, 
